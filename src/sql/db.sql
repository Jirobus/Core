...
CREATE TABLE IF NOT EXISTS `mydb`.`signatures` (
  ...
  `persons_id` INT NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Data for table `mydb`.`artefact_roles`
-- -----------------------------------------------------
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`artefact_roles` (`id`, `name`) VALUES (1, 'yields');
INSERT INTO `mydb`.`artefact_roles` (`id`, `name`) VALUES (2, 'requires');
